locals {
  ...
  cd_secrets = {
    INFISICAL_CLIENT_ID     = data.infisical_secrets.terraform.secrets["INFISICAL_PIPELINE_CLIENT_ID"].value
    INFISICAL_CLIENT_SECRET = data.infisical_secrets.terraform.secrets["INFISICAL_PIPELINE_CLIENT_SECRET"].value
  }
